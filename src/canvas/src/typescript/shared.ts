...
export function stringifyPoints(points: any): string {
...
export function makeSVGFromTemplate(template: any): SVG.G {
...
export function setupSkeletonEdges(skeleton: any, referenceSVG: any): void {
