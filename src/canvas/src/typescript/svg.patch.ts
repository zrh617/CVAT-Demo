...
function transform(this: any): void {
...
function drawCircles(this: any): void {
    ...
    this.set.each(function (this): void {
        this.remove();
    });
...
(SVG as any).Cube = SVG.invent({
    ...
    inherit: SVG.G,
    extend: {
        constructorMethod(this: any, points: string) {
        ...
        setupGrabPoints(this: any, circleType: Function | string) {
        ...
        selectize(this: any, value: boolean, options: object) {
        ...
        resize(this: any, value?: string | object) {
            ...
            this.face
                ...
                .on('resizing', (event: CustomEvent) => {
                    ...
                    const edge = getEdgeIndex(resizedCubePoint || 0);
            ...
            function setupDorsalEdge(this: any, edge: SVG.Line, orientation: Orientation) {
            ...
            function horizontalEdgeControl(this: any, updatingFace: any, midX: number, midY: number) {
        ...
        draggable(this: any, value: any, constraint: any) {
        ...
        attr(this: any, a: any, v: any, n: any) {
        ...
        paintOrientationLines(this: any) {
        ...
        dmove(this: any, dx: number, dy: number) {
        ...
        updateViewAndVM(this: any, build: boolean) {
        ...
        computeHeightFace(this: any, point: Point, index: number) {
            switch (index) {
                // fl
                case 1: {
