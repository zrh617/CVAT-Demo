...
function PropagateConfirmComponent(): JSX.Element {
    ...
    const startFrame = useSelector((state: CombinedState) => state.annotation.job.instance ? state.annotation.job.instance.startFrame : 0 );
    const stopFrame = useSelector((state: CombinedState) => state.annotation.job.instance ? state.annotation.job.instance.stopFrame : 0);
    ...
    return (
        <Modal
            ...
            cancelText='Cancel'
            onOk={() => {
                dispatch(propagateObjectAsync(frameNumber, targetFrame) as any)
