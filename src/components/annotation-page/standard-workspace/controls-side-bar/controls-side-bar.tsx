...
import {
    ActiveControl, ObjectType, Rotation, ShapeType, ToolsBlockerState,
} from '@/reducers';
import GlobalHotKeys, { KeyMap } from '@/utils/mousetrap-react';
import { Canvas, CanvasMode } from '@/canvas-wrapper';
...
import { MLModel } from '@/core-wrapper';
...
export default function ControlsSideBarComponent(props: Props): JSX.Element {
    ...
    return (
        <Layout.Sider className='cvat-canvas-controls-sidebar' theme='light' width={44}>
            ...
            <hr />
            <ObservedToolsControl onInteractionStart={function (activeInteractor: MLModel, activeLabelID: number): void {
                throw new Error('Function not implemented.');
            } } updateAnnotations={function (statesToUpdate: any[]): void {
                throw new Error('Function not implemented.');
            } } createAnnotations={function (sessionInstance: any, frame: number, statesToCreate: any[]): void {
                throw new Error('Function not implemented.');
            } } fetchAnnotations={function (): void {
                throw new Error('Function not implemented.');
            } } onSwitchToolsBlockerState={function (toolsBlockerState: ToolsBlockerState): void {
                throw new Error('Function not implemented.');
            } } switchNavigationBlocked={function (navigationBlocked: boolean): void {
                throw new Error('Function not implemented.');
            } } activeLabelID={0} canvasInstance={{}} labels={[]} states={[]} jobInstance={undefined} isActivated={false} frame={0} interactors={[]} detectors={[]} trackers={[]} curZOrder={0} defaultApproxPolyAccuracy={0} toolsBlockerState={undefined} frameIsDeleted={false} />
