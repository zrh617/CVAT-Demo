...
function withRouter(Component: JSX.IntrinsicAttributes | any) {
    function ComponentWithRouterProp(props: JSX.IntrinsicAttributes | TaskItemProps) {
...
class TaskItemComponent extends React.PureComponent<TaskItemProps> {
    ...
    private renderNavigation(): JSX.Element {
        const { taskInstance, router } = this.props;
        const { id } = taskInstance;
