...
import AttributeAnnotationWorkspace from '@/components/annotation-page-2.3/attribute-annotation-workspace/attribute-annotation-workspace';
import ReviewAnnotationsWorkspace from '@/components/annotation-page-2.3/review-workspace/review-workspace';
import StandardWorkspaceComponent from '@/components/annotation-page-2.3/standard-workspace/standard-workspace';
import StandardWorkspace3DComponent from '@/components/annotation-page-2.3/standard3D-workspace/standard3D-workspace';
import TagAnnotationWorkspace from '@/components/annotation-page-2.3/tag-annotation-workspace/tag-annotation-workspace';
import FiltersModalComponent from '@/components/annotation-page-2.3/top-bar/filters-modal';
import StatisticsModalComponent from '@/components/annotation-page-2.3/top-bar/statistics-modal';
import AnnotationTopBarContainer from '@/containers/annotation-page-2.3/top-bar/top-bar';
