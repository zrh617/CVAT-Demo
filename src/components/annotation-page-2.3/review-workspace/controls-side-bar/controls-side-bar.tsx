...
import RotateControl from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/rotate-control';
import CursorControl from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/cursor-control';
import MoveControl from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/move-control';
import FitControl from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/fit-control';
import ResizeControl from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/resize-control';
