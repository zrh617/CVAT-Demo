...
} from '@/canvas3d-wrapper';
import { Canvas } from '@/canvas-wrapper';
import ContextImage from '@/components/annotation-page-2.3/standard-workspace/context-image/context-image';
...
const CanvasWrapperComponent = (props: Props): ReactElement => {
    ...
    const { canvasInstance } = props as { canvasInstance: any };
