...
import ObjectItemElementComponent from '@/components/annotation-page-2.3/standard-workspace/objects-side-bar/object-item-element';
import ObjectItemContainer from '@/containers/annotation-page-2.3/standard-workspace/objects-side-bar/object-item';
