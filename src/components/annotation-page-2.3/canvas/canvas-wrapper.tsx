...
import FrameTags from '@/components/annotation-page-2.3/tag-annotation-workspace/frame-tags';
...
export default class CanvasWrapperComponent extends React.PureComponent<Props> {
    public componentDidMount(): void {
        ...
        const [wrapper] = window.document.getElementsByClassName('cvat-canvas-container') as any;
        canvasInstance?.html() && wrapper.appendChild(canvasInstance?.html());
    ...
    public componentDidUpdate(prevProps: Props): void {
        ...
        if (prevProps.sidebarCollapsed !== sidebarCollapsed) {
            const [sidebar] = window.document.getElementsByClassName('cvat-objects-sidebar') as any;
            if (sidebar) {
