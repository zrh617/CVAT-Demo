...
import { rememberObject, updateCanvasBrushTools } from '@/actions/annotation-actions-2.3';
...
function BrushTools(): React.ReactPortal | null {
    ...
    const dragBar = useDraggable(
        (): number[] => {
            const [element] = window.document.getElementsByClassName('cvat-brush-tools-toolbox') as any;
            if (element) {
                        ...
                        if (canvasInstance instanceof Canvas) {
                            ...
                            dispatch(
                                rememberObject({
                                    ...
                                    activeLabelID: defaultLabelID as any,
                                }),
                            );
                        }
                    }}
