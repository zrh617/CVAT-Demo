...
import { Canvas } from '@/canvas/src/typescript/canvas';
        ...
        if (expandedIssue === id) {
            issueDialogs.push(
                <IssueDialog
                    ...
                    resolve={() => {
                        dispatch(resolveIssueAsync(issue.id) as any);
                        setExpandedIssue(null);
                    }}
                    reopen={() => {
                        dispatch(reopenIssueAsync(issue.id) as any);
                    }}
                    comment={(message: string) => {
                        dispatch(commentIssueAsync(issue.id, message) as any);
                    }}
                />,
            );
