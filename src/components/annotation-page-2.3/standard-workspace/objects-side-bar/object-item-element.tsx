...
import { activateObject } from '@/actions/annotation-actions-2.3';
import ObjectButtonsContainer from '@/containers/annotation-page-2.3/standard-workspace/objects-side-bar/object-buttons';
import ItemDetailsContainer from '@/containers/annotation-page-2.3/standard-workspace/objects-side-bar/object-item-details';
