...
import LabelsList from '@/components/annotation-page-2.3/standard-workspace/objects-side-bar/labels-list';
...
import AppearanceBlock from '@/components/annotation-page-2.3/appearance-block';
import IssuesListComponent from '@/components/annotation-page-2.3/standard-workspace/objects-side-bar/issues-list';
...
function ObjectsSideBar(props: StateToProps & DispatchToProps & OwnProps): JSX.Element {
    ...
    const collapse = (): void => {
        const [collapser] = window.document.getElementsByClassName('cvat-objects-sidebar') as any;
