...
import { changeFrameAsync } from '@/actions/annotation-actions-2.3';
...
export default function LabelsListComponent(): JSX.Element {
    ...
    const dinamicLeftProps: any = Number.isInteger(nearestLeft) ?
        {
            onClick: () => dispatch(changeFrameAsync(nearestLeft) as any),
        } :
        {
            style: {
                pointerEvents: 'none',
    ...
    const dinamicRightProps: any = Number.isInteger(nearestRight) ?
        {
            onClick: () => dispatch(changeFrameAsync(nearestRight) as any),
        } :
        {
            style: {
                pointerEvents: 'none',
