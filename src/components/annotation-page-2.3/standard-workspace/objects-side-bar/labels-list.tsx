...
import { LabelType } from '@/core-wrapper';
import { CombinedState, ObjectType } from '@/reducers';
import { rememberObject, updateAnnotationsAsync } from '@/actions/annotation-actions';
import LabelItemContainer from '@/containers/annotation-page-2.3/standard-workspace/objects-side-bar/label-item';
            ...
            if (Number.isInteger(labelID) && label) {
                if (Number.isInteger(activatedStateID)) {
                    ...
                    if (activatedState && labelIsApplicable) {
                        ...
                        dispatch(updateAnnotationsAsync([activatedState]) as any);
                    }
                } else {
