...
import { Label, LabelType } from '@/core-wrapper';
import { Canvas3d as Canvas } from '@/canvas3d-wrapper';
import MoveControl, {
    Props as MoveControlProps,
} from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/move-control';
import CursorControl, {
    Props as CursorControlProps,
} from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/cursor-control';
import DrawCuboidControl, {
    Props as DrawCuboidControlProps,
} from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/draw-cuboid-control';
import GroupControl, {
    Props as GroupControlProps,
} from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/group-control';
import GlobalHotKeys, { KeyMap } from '@/utils/mousetrap-react';
import ControlVisibilityObserver from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/control-visibility-observer';
