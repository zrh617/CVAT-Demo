...
import ColorPicker from '@/components/annotation-page-2.3/standard-workspace/objects-side-bar/color-picker';
...
function AppearanceBlock(props: Props): JSX.Element {
    ...
    props.jobInstance && (is2D = jobInstance.dimension === DimensionType.DIM_2D)
