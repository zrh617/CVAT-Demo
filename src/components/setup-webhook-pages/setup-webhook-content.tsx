...
function SetupWebhookContent(props: Props): JSX.Element {
    ...
    const handleSubmit = useCallback(async (): Promise<any | null> => {
        try {
            ...
            if (webhook) {
                ...
                await dispatch(updateWebhookAsync(webhook) as any);
            } else {
                const rawWebhookData: any = {
                ...
                await dispatch(createWebhookAsync(rawWebhookData) as any);
            }
            form.resetFields();
