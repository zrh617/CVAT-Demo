...
class LoggerStorage {
        ...
        this.ignoreRules = {
            [LogType.zoomImage]: {
                ...
                ignore(previousLog: Log) {
                    return (Date.now() - previousLog.time.getTime()) < (this.timeThreshold || 1000);
                },
            },
    ...
    public async configure(isActiveChecker: any, activityHelper: any): Promise<void> {
        const result = await PluginRegistry.apiWrapper.call(
            this,
            LoggerStorage.prototype.configure as any,
            isActiveChecker,
            activityHelper,
        );
        return result;
    ...
    public async log(logType: LogType, payload = {}, wait = false): Promise<Log> {
        const result = await PluginRegistry.apiWrapper.call(this, LoggerStorage.prototype.log as any, logType, payload, wait);
        return result as any;
    }

    public async save(): Promise<void> {
        const result = await PluginRegistry.apiWrapper.call(this, LoggerStorage.prototype.save as any);
        return result;
    }
}
