...
export default class ObjectState {
    ...
    public points!: number[] | any;
    public rotation!: number | any;
    ...
    async save(): Promise<ObjectState> {
        const result: any = await PluginRegistry.apiWrapper.call(this, ObjectState.prototype.save as any);
        return result;
    }
    ...
    async delete(frame, force = false): Promise<boolean> {
        const result: any = await PluginRegistry.apiWrapper.call(this, ObjectState.prototype.delete as any, frame, force);
        return result;
    }
}
