...
export class Attribute {
    ...
    public inputType: AttrInputType = 'number';
    ...
    constructor(initialData: RawAttribute) {
        ...
        if (!Object.values(AttributeType).includes(data.input_type as any)) {
...
export class Label {
    ...
    public readonly attributes: Attribute[] | undefined;
    public readonly type: LabelType | undefined;
    public structure: {
        sublabels: Label[];
        svg: string;
    } | null | undefined;
