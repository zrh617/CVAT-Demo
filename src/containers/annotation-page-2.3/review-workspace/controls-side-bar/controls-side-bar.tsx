...
import { selectIssuePosition as selectIssuePositionAction, rotateCurrentFrame } from '@/actions/annotation-actions-2.3';
import ControlsSideBarComponent from '@/components/annotation-page-2.3/review-workspace/controls-side-bar/controls-side-bar';
