...
import CanvasWrapperComponent from '@/components/annotation-page-2.3/canvas/canvas-wrapper3D';
import {
    activateObject,
    confirmCanvasReady,
...
export default connect(mapStateToProps, mapDispatchToProps)(CanvasWrapperComponent as any);
