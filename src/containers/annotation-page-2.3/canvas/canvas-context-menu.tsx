...
import CanvasContextMenuComponent from '@/components/annotation-page-2.3/canvas/canvas-context-menu';
import { updateCanvasContextMenu } from '@/actions/annotation-actions-2.3';
import { reviewActions, finishIssueAsync } from '@/actions/review-actions';
import { ThunkDispatch } from '@/utils/redux';
import { Canvas } from '@/canvas-wrapper';
import { ObjectState } from '@/core-wrapper';
...
class CanvasContextMenuContainer extends React.PureComponent<Props, State> {
    ...
    public componentDidUpdate(prevProps: Props): void {
        ...
        const [element] = window.document.getElementsByClassName('cvat-canvas-context-menu') as any;
...
export default connect(mapStateToProps, mapDispatchToProps)(CanvasContextMenuContainer as any);
