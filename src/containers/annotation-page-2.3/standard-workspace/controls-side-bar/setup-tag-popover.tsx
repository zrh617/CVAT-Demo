...
import { createAnnotationsAsync, rememberObject } from '@/actions/annotation-actions-2.3';
import SetupTagPopoverComponent from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/setup-tag-popover';

import { Canvas } from '@/canvas-wrapper';
import { getCore, Label } from '@/core-wrapper';
