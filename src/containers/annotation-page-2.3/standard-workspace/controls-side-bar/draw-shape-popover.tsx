...
import { rememberObject } from '@/actions/annotation-actions-2.3';
import { Canvas, RectDrawingMethod, CuboidDrawingMethod } from '@/canvas-wrapper';
import DrawShapePopoverComponent from '@/components/annotation-page-2.3/standard-workspace/controls-side-bar/draw-shape-popover';
...
class DrawShapePopoverContainer extends React.PureComponent<Props, State> {
    ...
    constructor(props: Props) {
        ...
        this.satisfiedLabels = props.labels.filter((label: any) => {
