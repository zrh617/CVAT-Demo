...
import { updateAnnotationsAsync } from '@/actions/annotation-actions-2.3';

import LabelItemComponent from '@/components/annotation-page-2.3/standard-workspace/objects-side-bar/label-item';
