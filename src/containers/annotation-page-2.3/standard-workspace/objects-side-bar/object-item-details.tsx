...
import ObjectItemDetails from '@/components/annotation-page-2.3/standard-workspace/objects-side-bar/object-item-details';
import { AnyAction } from 'redux';
import { updateAnnotationsAsync, collapseObjectItems } from '@/actions/annotation-actions-2.3';
...
function mapDispatchToProps(dispatch: Dispatch<AnyAction>): DispatchToProps {
    return {
        updateState(state: ObjectState): void {
            dispatch(updateAnnotationsAsync([state]) as any);
        },
        ...
        if (state) {
            return (
                <ObjectItemDetails
                    ...
                    attributes={[...state.label.attributes as any]}
                />
            );
        }
