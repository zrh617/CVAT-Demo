...
import ObjectStateItemComponent from '@/components/annotation-page-2.3/standard-workspace/objects-side-bar/object-item';
import { getColor } from '@/components/annotation-page-2.3/standard-workspace/objects-side-bar/shared';
