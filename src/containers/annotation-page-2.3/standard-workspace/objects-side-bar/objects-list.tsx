...
import ObjectsListComponent from '@/components/annotation-page-2.3/standard-workspace/objects-side-bar/objects-list';
import {
...
import { ObjectState, ShapeType } from '@/core-wrapper';
