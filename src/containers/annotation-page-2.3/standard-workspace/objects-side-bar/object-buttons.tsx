...
import { updateAnnotationsAsync, changeFrameAsync } from '@/actions/annotation-actions-2.3';
import { CombinedState } from '@/reducers';
import ItemButtonsComponent from '@/components/annotation-page-2.3/standard-workspace/objects-side-bar/object-item-buttons';
