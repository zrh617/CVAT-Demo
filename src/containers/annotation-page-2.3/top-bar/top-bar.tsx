...
import AnnotationTopBarComponent from '@/components/annotation-page-2.3/top-bar/top-bar';
...
function mapStateToProps(state: CombinedState): StateToProps {
    ...
    let frameIsDeleted = false
    state.annotation.player.frame.data && (frameIsDeleted = state.annotation.player.frame.data.deleted)
...
class AnnotationTopBarContainer extends React.PureComponent<Props, State> {
    private inputFrameRef: React.RefObject<any>;
    private autoSaveInterval: number | undefined;
    private unblock: any;

    constructor(props: Props) {
        super(props);
        this.inputFrameRef = React.createRef<any>();
        this.state = {
    ...
    public componentDidMount(): void {
        const {
            autoSaveInterval, jobInstance, setForceExitAnnotationFlag,
        } = this.props;
    ...
    public render(): JSX.Element {
        ...
        this.props.jobInstance && (
            startFrame = this.props.jobInstance.startFrame,
            stopFrame = this.props.jobInstance.stopFrame
        )
