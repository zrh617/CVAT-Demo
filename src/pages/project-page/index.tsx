...
export default function ProjectPageComponent(): JSX.Element {
    ...
    useEffect(() => {
        dispatch(getProjectTasksAsync({ ...updatedQuery, projectId: id }) as any);
        setIsMounted(true);
    }, []);
    ...
    useEffect(() => {
        if (!project) {
            dispatch(getProjectsAsync({ id }, updatedQuery) as any);
        }
    }, []);
                        ...
                        .map((task: Task) => (
                            <TaskItem
                                ...
                                cancelAutoAnnotation={() => {
                                    dispatch(cancelInferenceAsync(task.instance.id) as any);
                                }}
                                ...
                                overlay={(
                                    <CvatDropdownMenuPaper>
                                        ...
                                        <Button
                                            ...
                                            onClick={() => navigate(`/tasks/create?projectId=${id}&many=true`)}
                                        >
                                            Create multi tasks
                                        </Button>
                                    </CvatDropdownMenuPaper>
