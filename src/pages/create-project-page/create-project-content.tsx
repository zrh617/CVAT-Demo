...
import { Storage, StorageData } from '@/core-wrapper';
...
function NameConfigurationForm(
    { formRef, inputRef }:
    { formRef: RefObject<FormInstance>, inputRef: RefObject<any> },
):JSX.Element {
    return (
...
export default function CreateProjectContent(): JSX.Element {
    ...
    const submit = async (): Promise<any> => {
        try {
            ...
            const createdProject = await dispatch(createProjectAsync(projectData) as any);
