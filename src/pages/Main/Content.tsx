...
import { Button, Dropdown, Menu, Breadcrumb, Skeleton } from 'antd'
import {
    createBrowserRouter,
...
import JobsPageComponent from '@/pages/jobs-page/jobs-page';

import TasksPageContainer from '@/containers/tasks-page/tasks-page';
import CreateTaskPageContainer from '@/containers/create-task-page/create-task-page';
import TaskPageContainer from '@/containers/task-page/task-page';

import ProjectPageComponent from '@/pages/project-page';
...
import AnnotationPageContainer2 from '@/containers/annotation-page-2.3/annotation-page';
                    ...
                    <Layout>
                        ...
                        <Layout.Content>
                            ...
                            <Routes>
                                ...
                                <Route path='/' element={<ProjectsPageComponent />} />
                                <Route path='/auth/login' element={<LoginPageContainer />} />
                                <Route path='/projects' element={<ProjectsPageComponent />} />
                                <Route path='/projects/create' element={<CreateProjectPageComponent />} />
                                ...
                                <Route path='/tasks/create' element={<CreateTaskPageContainer />} />
                                <Route path='/tasks/:id' element={<TaskPageContainer />} />
                                <Route path='/tasks/:tid/jobs/:jid' element={<AnnotationPageContainer />} />
                                <Route path='/jobs' element={<JobsPageComponent />} />
