...
export class FrameProvider {
    ...
    */
    frames;
    requestedBlockToDecode;
    blocksAreBeingDecoded;
    promisedFrames;
    currentDecodingThreads;
    currentFrame;
    mutex;

    dimension;
    workerThreadsLimit;
    cachedEncodedBlocksLimit;
    cachedDecodedBlocksLimit;
    ...
    _checkDecodeRequests() {
        // console.log(this.requestedBlockToDecode, this.currentDecodingThreads, this.workerThreadsLimit);
