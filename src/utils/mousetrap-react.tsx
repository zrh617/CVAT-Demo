...
export default function GlobalHotKeys(props: Props): JSX.Element {
    ...
    useEffect(() => {
        ...
        //     console.log(keyMap[key]?.sequences, 'handler', handler, 'keyMap[key]?.action', keyMap[key]?.action);
            
        //     Mousetrap.bind(keyMap[key]?.sequences, handlers[key], keyMap[key]?.action);
